        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedTransportation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PickUpTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    DropOffTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    SpecialRequest = table.Column<bool>(type: "bit", nullable: true),
                    ArrivalTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    DepartureTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    WhichFriday = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FridayTripType = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Location_DropOffLocationID",
                table: "Location",
                column: "DropOffLocationID");

            migrationBuilder.CreateIndex(
                name: "IX_Location_PickUpLocationID",
                table: "Location",
                column: "PickUpLocationID");

            migrationBuilder.CreateIndex(
                name: "IX_RegistertionDaysModel_RegistrationID",
                table: "RegistertionDaysModels",
